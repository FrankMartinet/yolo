...
# model = attempt_load_weights("runs/detect/train2/weights/best.pt")
...
files = os.listdir("./datasets/coco8/images/val")

for file in files:
    print(file)
    img_path = os.path.join("./datasets/coco8/images/val",file)
    ...
    preds = yolo_postprocess(preds, image)

...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default="./runs/train/train/weights/best.onnx", help="Input your ONNX model.")
    parser.add_argument("--img", default="./datasets/coco/val/000000000139.jpg", help="Path to input image.")
